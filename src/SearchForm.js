        ...
        <Form className="mb-4">
            <Form.Row className="align-items-end">
                <Form.Group as={Col}>
                    ...
                    <Form.Control onChange={onParamChange} value={params.description} name="description" types="text" />
                </Form.Group>

                <Form.Group as={Col}>
                    <Form.Label>Location</Form.Label>
                    <Form.Control onChange={onParamChange} value={params.location} name="location" types="text" />
                </Form.Group>
